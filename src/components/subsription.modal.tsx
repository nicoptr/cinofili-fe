...
import { type ApiEvent, fetchEvents } from "../services/apiEvent";
...
export default function SubscriptionModal({
    ...
    useEffect(() => {
        ...
        fetchCategories().then(r => setCategories(r.docs)).catch(console.error);
        fetchEvents().then(r => setEvents(r.docs)).catch(console.error);
    }, [isOpen]);
